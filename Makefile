...
clean:
	rm -f object/*.o && rm -f test_message && rm -f test_table
...
test_message: $(O_FILES)/test_message.o $(O_FILES)/data.o $(O_FILES)/entry.o $(O_FILES)/list.o $(O_FILES)/message.o
	$(CC) $(CFLAGS) -o test_message $(O_FILES)/test_message.o $(O_FILES)/data.o $(O_FILES)/entry.o $(O_FILES)/list.o $(O_FILES)/message.o


# Testes
$(O_FILES)/test_message.o: $(C_FILES)/test_message.c $(H_FILES)/data.h $(H_FILES)/entry.h $(H_FILES)/list.h $(H_FILES)/message.h
...
$(O_FILES)/message.o: $(C_FILES)/message.c $(H_FILES)/data.h $(H_FILES)/entry.h $(H_FILES)/message.h $(H_FILES)/message-private.h
